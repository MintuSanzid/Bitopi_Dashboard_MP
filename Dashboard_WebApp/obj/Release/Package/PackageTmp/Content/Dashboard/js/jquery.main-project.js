...
function initDashboardChart() {
    var defaultOptions = {
        chartLabel: { title: 'Project', text: 'Dashboard' },
        width: 1400,
        height: 1200,
        defaultAngle: 0,
        labelsRadius: 450,
    ...
    /////// here modifyed by Mintu for json objectdata loaded ///////
    //var datafromMvc;
    //$.ajax({ url: "JsonForProject", type: "GET", success: function (dat) {
    //        datafromMvc = jQuery.parseJSON(dat);
    //    }
    //});
    /////// here modifyed by Mintu for json objectdata loaded ///////
